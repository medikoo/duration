...
map = {
	y: function () { return String(this.year); },
	m: function () { return pad.call(this.month, 2); },
	d: function () { return pad.call(this.day, 2); },
	H: function () { return pad.call(this.hour, 2); },
	M: function () { return pad.call(this.minute, 2); },
	S: function () { return pad.call(this.second, 2); },
	L: function () { return pad.call(this.millisecond, 3); },

	ms: function () { return String(this.months); },
	ds: function () { return String(this.days); },
	Hs: function () { return String(this.hours); },
	Ms: function () { return String(this.minutes); },
	Ss: function () { return String(this.seconds); },
	Ls: function () { return String(this.milliseconds); }
};
...
Duration.prototype = Object.create(Object.prototype, {
	...
	seconds: d.gs(function () { return floor(this.valueOf() / 1000); }),
	minutes: d.gs(function () { return floor(this.valueOf() / (1000 * 60)); }),
	hours: d.gs(function () { return floor(this.valueOf() / (1000 * 60 * 60)); }),
	days: d.gs(function () {
		return floor(this.valueOf() / (1000 * 60 * 60 * 24));
	}),
